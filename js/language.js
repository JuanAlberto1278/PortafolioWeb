const translations = {
    es: {
      ...
      // --- Navegación (Ya tenías la mayoría, ajusto habilidades) ---
      nav_inicio: "Inicio",
      nav_sobremi: "Sobre mí",
      nav_habilidadesT: "Habilidades Técnicas", // Clave separada
      ...
      // --- Sección Sobre Mí ---
      sobreMi: "Sobre mí",
      sobreMiTexto: `Soy Ingeniero en Desarrollo de Software. Cuento con experiencia en desarrollo web utilizando tecnologías como <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, y frameworks modernos como <strong>Angular</strong>. Además, tengo conocimientos en desarrollo <strong>Back-End</strong> con <strong>Java</strong> y <strong>C#</strong>.`,

      // --- Sección Habilidades Técnicas ---
      habilidadesTec: "Habilidades Técnicas",
      habTec_html: "HTML",
      habTec_css: "CSS",
      ...
      habBlan_problemas: "Resolución de problemas",
      ...
      idi_espanol: "<strong>Español:</strong> Nativo",
      idi_ingles: "<strong>Inglés:</strong> Intermedio",

      // --- Sección Educación ---
      educacion: "Educación",
      educacionTexto: `<strong>Universidad Cenfotec</strong><br />Bachillerato en Ingeniería de Software<br />📅 2023 - 2026<br />📍 San José, Costa Rica`,
      ...
      logro_qa_desc:
        "Proyecto grupal: Página de juegos para niños enfocada en habilidades STEAM.",
      logro_be_titulo: "<strong>Desarrollo Back-End</strong>",
      logro_be_desc:
        "Proyecto grupal: Aplicación de reseñas de sitios de vacaciones.",

      // --- Sección Certificaciones ---
      certificaciones: "Certificaciones",
      cert_ti_titulo: "<strong>Certificación Técnico de TI</strong>",
      cert_ti_desc:
        "Instituto Nacional del Aprendizaje — 2020<br />📍 San José, Costa Rica",
      cert_scrum_titulo: "<strong>Certificación Scrum</strong>",
      cert_scrum_desc: "ScrumStudy — 2023",

      // --- Sección Proyectos ---
      proyectos: "Proyectos",
      proj1_titulo: "Cenfomon",
      proj1_desc: "Pequeño juego basado en el juego Pokémon",
      proj2_titulo: "Mindmat",
      proj2_desc:
        "Página de juegos basada en el modelo de Aprendizaje STEAM, diseñada especialmente para niños",
      proj3_titulo: "Simecid",
      proj3_desc: "Simulación de Programa de Citas Médicas",
      proj4_titulo: "Base de datos simple",
      proj4_desc:
        "Pequeño proyecto de gestión de tareas, usando una base de datos para pruebas",
    ...
    en: {
      ...
      // --- Sección Educación ---
      educacion: "Education",
      educacionTexto: `<strong>Universidad Cenfotec</strong><br />Bachelor's Degree in Software Engineering<br />📅 2023 - 2026<br />📍 San José, Costa Rica`,
      ...
      cert_ti_desc:
        "National Learning Institute — 2020<br />📍 San José, Costa Rica",
      ...
      proyectos: "Projects",
      proj1_titulo: "Cenfomon",
      proj1_desc: "Small game based on the Pokémon game",
      proj2_titulo: "Mindmat",
      proj2_desc:
  ...
  const setTranslation = (lang) => {
    ...
    // --- Función auxiliar para traducir elementos con data-key ---
    ...
    // --- Función auxiliar para traducir múltiples elementos con data-key ---
